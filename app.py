...
# Set Up the Database
engine = create_engine("sqlite:///hawaii.sqlite") # Allows us to access the database in SQLite
Base = automap_base() # Reflect the database into our classes
Base.prepare(engine, reflect=True) # Reflect the database into our classes
